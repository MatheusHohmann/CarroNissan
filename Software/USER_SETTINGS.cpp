...
IPAddress local_IP(150, 162, 142, 248);
IPAddress gateway(150, 162, 142, 254);
...
const char* mqtt_topic_name =
    "Batt/Car01";  // Custom MQTT topic name. Previously, the name was automatically set to "battery-emulator_esp32-XXXXXX"
const char* mqtt_object_id_prefix =
    "Car01_";  // Custom prefix for MQTT object ID. Previously, the prefix was automatically set to "esp32-XXXXXX_"
const char* mqtt_device_name =
    "Car 01";  // Custom device name in Home Assistant. Previously, the name was automatically set to "BatteryEmulator_esp32-XXXXXX"
const char* ha_device_id =
    "Batt-Car01";  // Custom device ID in Home Assistant. Previously, the ID was always "battery-emulator"
