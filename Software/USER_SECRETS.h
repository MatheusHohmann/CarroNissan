...
#define AP_PASSWORD ""  // Minimum of 8 characters; set to blank if you want the access point to be open

//Name and password of Wifi network you want the emulator to connect to
#define WIFI_SSID "Fotovoltaica_Bloco_B"          // Maximum of 63 characters
#define WIFI_PASSWORD "fotovoltaica"  // Minimum of 8 characters
...
//MQTT credentials
#define MQTT_SERVER "150.162.142.79"   // MQTT server address
