...
typedef struct {
  ...
  // ---- NEW: temperaturas individuais do pack (décimos de °C) ----
  int16_t temperature_sensors_dC[4] = {0, 0, 0, 0};  // INT16_MIN para "inválido" (se preferir)
  uint8_t temperature_sensor_count = 0;              // 3 ou 4
